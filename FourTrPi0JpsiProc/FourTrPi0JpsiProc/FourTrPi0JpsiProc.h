...
//
/**\class FourTrPi0JpsiProc FourTrPi0JpsiProc.h FourTrPi0JpsiProc/FourTrPi0JpsiProc.h
...
class FourTrPi0JpsiProc : public Processor
{
   ...
   public:
      ...
      FourTrPi0JpsiProc( void );                      // anal1 
      virtual ~FourTrPi0JpsiProc();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor ----------------
      FourTrPi0JpsiProc( const FourTrPi0JpsiProc& );

      // ------------ assignment operator(s) ---------------------
      const FourTrPi0JpsiProc& operator=( const FourTrPi0JpsiProc& );

      // ------------ private member functions -------------------
      void bind( 
         ActionBase::ActionResult (FourTrPi0JpsiProc::*iMethod)( Frame& ),
