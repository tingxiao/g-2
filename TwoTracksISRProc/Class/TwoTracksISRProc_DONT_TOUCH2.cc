...
// Module:      TwoTracksISRProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TwoTracksISRProc:
//              creates a new TwoTracksISRProc instance each time 
