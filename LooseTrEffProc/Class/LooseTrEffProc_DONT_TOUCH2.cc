...
// Module:      LooseTrEffProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor LooseTrEffProc:
//              creates a new LooseTrEffProc instance each time 
