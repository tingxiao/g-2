...
//
static const char* const kFacilityString = "Processor.FourTrJpsiProc" ;
...
//
FourTrJpsiProc::FourTrJpsiProc( void )               // anal1
   : Processor( "FourTrJpsiProc" )
{
   ...
   bind( &FourTrJpsiProc::event,    Stream::kEvent );
   bind( &FourTrJpsiProc::beginRun, Stream::kBeginRun );
   //bind( &FourTrJpsiProc::endRun,   Stream::kEndRun );
...
FourTrJpsiProc::~FourTrJpsiProc()                    // anal5
{
...
// --------------------------- init method -------------------------
void
FourTrJpsiProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
FourTrJpsiProc::terminate( void )     // anal5 "Interactive"
{
...
void
FourTrJpsiProc::hist_book( HIHistoManager& iHistoManager )
{
...
FourTrJpsiProc::event( Frame& iFrame )          // anal3 equiv.
{
...
ActionBase::ActionResult
FourTrJpsiProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
FourTrJpsiProc::endRun( Frame& iFrame )         // anal4 equiv.
{
...
int FourTrJpsiProc::CompareKins( FAItem<KTKinematicData>  &k1, 
...
/*
// return 1 if they are they same kinematical object
int FourTrJpsiProc::CompareKins( FAItem<TDKinematicFit>  &k1, 
...
double FourTrJpsiProc::calcDOCA( double iD,
		       	     double iPhi )
{
