...
// Module:      FourTrJpsiProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor FourTrJpsiProc:
//              creates a new FourTrJpsiProc instance each time 
