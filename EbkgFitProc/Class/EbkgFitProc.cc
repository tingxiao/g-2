...
//
static const char* const kFacilityString = "Processor.EbkgFitProc" ;
...
//
EbkgFitProc::EbkgFitProc( void )               // anal1
   : Processor( "EbkgFitProc" )
{
   ...
   bind( &EbkgFitProc::event,    Stream::kEvent );
   bind( &EbkgFitProc::beginRun, Stream::kBeginRun );
   //bind( &EbkgFitProc::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
EbkgFitProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
EbkgFitProc::terminate( void )     // anal5 "Interactive"
{
...
void
EbkgFitProc::hist_book( HIHistoManager& iHistoManager )
{
...
EbkgFitProc::event( Frame& iFrame )          // anal3 equiv.
{
...
ActionBase::ActionResult
EbkgFitProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
EbkgFitProc::endRun( Frame& iFrame )         // anal4 equiv.
{
