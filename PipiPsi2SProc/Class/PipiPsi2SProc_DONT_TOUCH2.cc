...
// Module:      PipiPsi2SProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor PipiPsi2SProc:
//              creates a new PipiPsi2SProc instance each time 
