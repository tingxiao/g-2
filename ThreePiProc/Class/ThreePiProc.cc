...
// user include files
#include "ThreePiProc/ThreePiProc.h"
...
//
static const char* const kFacilityString = "Processor.ThreePiProc" ;
...
//
ThreePiProc::ThreePiProc( void )               // anal1
   : Processor( "ThreePiProc" )
{
   ...
   bind( &ThreePiProc::event,    Stream::kEvent );
   bind( &ThreePiProc::beginRun, Stream::kBeginRun );
   //bind( &ThreePiProc::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
ThreePiProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
ThreePiProc::terminate( void )     // anal5 "Interactive"
{
...
void
ThreePiProc::hist_book( HIHistoManager& iHistoManager )
{
   ...
   h_pip_eop1 = iHistoManager.histogram(501, "pi+ E/p, p=0-100 MeV", 2000, 0., 2);
   h_pip_eop2 = iHistoManager.histogram(502, "pi+ E/p, p=100-200 MeV", 2000, 0., 2);
   h_pip_eop3 = iHistoManager.histogram(503, "pi+ E/p, p=200-300 MeV", 2000, 0., 2);
   h_pip_eop4 = iHistoManager.histogram(504, "pi+ E/p, p=300-400 MeV", 2000, 0., 2);
   h_pip_eop5 = iHistoManager.histogram(505, "pi+ E/p, p=400-500 MeV", 2000, 0., 2);
   h_pip_eop6 = iHistoManager.histogram(506, "pi+ E/p, p=500-600 MeV", 2000, 0., 2);
   h_pip_eop7 = iHistoManager.histogram(507, "pi+ E/p, p=600-700 MeV", 2000, 0., 2);
   h_pip_eop8 = iHistoManager.histogram(508, "pi+ E/p, p=700-800 MeV", 2000, 0., 2);
   h_pip_eop9 = iHistoManager.histogram(509, "pi+ E/p, p=800-900 MeV", 2000, 0., 2);
   h_pip_eop10 = iHistoManager.histogram(510, "pi+ E/p, p=900-1000 MeV", 2000, 0., 2);
   h_pip_eop11 = iHistoManager.histogram(511, "pi+ E/p, p=1000-1100 MeV", 2000, 0., 2);
   h_pip_eop12 = iHistoManager.histogram(512, "pi+ E/p, p=1100-1200 MeV", 2000, 0., 2);
   h_pip_eop13 = iHistoManager.histogram(513, "pi+ E/p, p=1200-1300 MeV", 2000, 0., 2);
   h_pip_eop14 = iHistoManager.histogram(514, "pi+ E/p, p=1300-1400 MeV", 2000, 0., 2);
   h_pip_eop15 = iHistoManager.histogram(515, "pi+ E/p, p=1400-1500 MeV", 2000, 0., 2);
   h_pip_eop16 = iHistoManager.histogram(516, "pi+ E/p, p=1500-1600 MeV", 2000, 0., 2);
   h_pip_eop17 = iHistoManager.histogram(517, "pi+ E/p, p=1600-1700 MeV", 2000, 0., 2);
   h_pip_eop18 = iHistoManager.histogram(518, "pi+ E/p, p=1700-1800 MeV", 2000, 0., 2);
   h_pip_eop19 = iHistoManager.histogram(519, "pi+ E/p, p=1800-1900 MeV", 2000, 0., 2);
   h_pip_eop20 = iHistoManager.histogram(520, "pi+ E/p, p=1900-2000 MeV", 2000, 0., 2);
   h_pim_eop1 = iHistoManager.histogram(521, "pi- E/p, p=0-100 MeV", 2000, 0., 2);
   h_pim_eop2 = iHistoManager.histogram(522, "pi- E/p, p=100-200 MeV", 2000, 0., 2);
   h_pim_eop3 = iHistoManager.histogram(523, "pi- E/p, p=200-300 MeV", 2000, 0., 2);
   h_pim_eop4 = iHistoManager.histogram(524, "pi- E/p, p=300-400 MeV", 2000, 0., 2);
   h_pim_eop5 = iHistoManager.histogram(525, "pi- E/p, p=400-500 MeV", 2000, 0., 2);
   h_pim_eop6 = iHistoManager.histogram(526, "pi- E/p, p=500-600 MeV", 2000, 0., 2);
   h_pim_eop7 = iHistoManager.histogram(527, "pi- E/p, p=600-700 MeV", 2000, 0., 2);
   h_pim_eop8 = iHistoManager.histogram(528, "pi- E/p, p=700-800 MeV", 2000, 0., 2);
   h_pim_eop9 = iHistoManager.histogram(529, "pi- E/p, p=800-900 MeV", 2000, 0., 2);
   h_pim_eop10 = iHistoManager.histogram(530, "pi- E/p, p=900-1000 MeV", 2000, 0., 2);
   h_pim_eop11 = iHistoManager.histogram(531, "pi- E/p, p=1000-1100 MeV", 2000, 0., 2);
   h_pim_eop12 = iHistoManager.histogram(532, "pi- E/p, p=1100-1200 MeV", 2000, 0., 2);
   h_pim_eop13 = iHistoManager.histogram(533, "pi- E/p, p=1200-1300 MeV", 2000, 0., 2);
   h_pim_eop14 = iHistoManager.histogram(534, "pi- E/p, p=1300-1400 MeV", 2000, 0., 2);
   h_pim_eop15 = iHistoManager.histogram(535, "pi- E/p, p=1400-1500 MeV", 2000, 0., 2);
   h_pim_eop16 = iHistoManager.histogram(536, "pi- E/p, p=1500-1600 MeV", 2000, 0., 2);
   h_pim_eop17 = iHistoManager.histogram(537, "pi- E/p, p=1600-1700 MeV", 2000, 0., 2);
   h_pim_eop18 = iHistoManager.histogram(538, "pi- E/p, p=1700-1800 MeV", 2000, 0., 2);
   h_pim_eop19 = iHistoManager.histogram(539, "pi- E/p, p=1800-1900 MeV", 2000, 0., 2);
   h_pim_eop20 = iHistoManager.histogram(540, "pi- E/p, p=1900-2000 MeV", 2000, 0., 2);
...
ThreePiProc::event( Frame& iFrame )          // anal3 equiv.
{
...
//////////////////////////////// do the fit with 2 pions and 1 pi0  ///////////////////
...
ActionBase::ActionResult
ThreePiProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
ThreePiProc::endRun( Frame& iFrame )         // anal4 equiv.
{
...
double ThreePiProc::calcDOCA( double iD,
		       	     double iPhi )
{
