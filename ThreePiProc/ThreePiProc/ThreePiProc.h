...
// Module:      ThreePiProc
//
/**\class ThreePiProc ThreePiProc.h ThreePiProc/ThreePiProc.h
...
class ThreePiProc : public Processor
{
   ...
   public:
      ...
      ThreePiProc( void );                      // anal1 
      virtual ~ThreePiProc();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor ----------------
      ThreePiProc( const ThreePiProc& );

      // ------------ assignment operator(s) ---------------------
      const ThreePiProc& operator=( const ThreePiProc& );

      // ------------ private member functions -------------------
      void bind( 
         ActionBase::ActionResult (ThreePiProc::*iMethod)( Frame& ),
