...
//
/**\class TwoTrPi0JpsiProc TwoTrPi0JpsiProc.h TwoTrPi0JpsiProc/TwoTrPi0JpsiProc.h
...
class TwoTrPi0JpsiProc : public Processor
{
   ...
   public:
      ...
      TwoTrPi0JpsiProc( void );                      // anal1 
      virtual ~TwoTrPi0JpsiProc();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor ----------------
      TwoTrPi0JpsiProc( const TwoTrPi0JpsiProc& );

      // ------------ assignment operator(s) ---------------------
      const TwoTrPi0JpsiProc& operator=( const TwoTrPi0JpsiProc& );
