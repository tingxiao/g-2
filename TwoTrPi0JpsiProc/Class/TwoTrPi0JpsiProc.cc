...
//
static const char* const kFacilityString = "Processor.TwoTrPi0JpsiProc" ;
...
//
TwoTrPi0JpsiProc::TwoTrPi0JpsiProc( void )               // anal1
   : Processor( "TwoTrPi0JpsiProc" )
{
   ...
   bind( &TwoTrPi0JpsiProc::event,    Stream::kEvent );
   bind( &TwoTrPi0JpsiProc::beginRun, Stream::kBeginRun );
   //bind( &TwoTrPi0JpsiProc::endRun,   Stream::kEndRun );
...
TwoTrPi0JpsiProc::~TwoTrPi0JpsiProc()                    // anal5
{
...
// --------------------------- init method -------------------------
void
TwoTrPi0JpsiProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
TwoTrPi0JpsiProc::terminate( void )     // anal5 "Interactive"
{
...
enum { k_NShower, k_NTrack, k_TCharge, 
	...
	pi0te9,pi0px9,pi0py9,pi0pz9,
        pi0te10,pi0px10,pi0py10,pi0pz10,
...
void
TwoTrPi0JpsiProc::hist_book( HIHistoManager& iHistoManager )
{
   ...
   ntNames.addVar(f1pi0te,    "f1pi0te");
   ntNames.addVar(f1pi0px,    "f1pi0px");
   ntNames.addVar(f1pi0py,    "f1pi0py");
   ntNames.addVar(f1pi0pz,    "f1pi0pz");

   ntNames.addVar(f1pi0hie,    "f1pi0hie");
   ntNames.addVar(f1pi0loe,    "f1pi0loe");
   ...
   ntNames.addVar(pi0te1,    "pi0te1");
   ntNames.addVar(pi0px1,    "pi0px1");
   ntNames.addVar(pi0py1,    "pi0py1");
   ntNames.addVar(pi0pz1,    "pi0pz1");

   ntNames.addVar(pi0te2,    "pi0te2");
   ntNames.addVar(pi0px2,    "pi0px2");
   ntNames.addVar(pi0py2,    "pi0py2");
   ntNames.addVar(pi0pz2,    "pi0pz2");

   ntNames.addVar(pi0te3,    "pi0te3");
   ntNames.addVar(pi0px3,    "pi0px3");
   ntNames.addVar(pi0py3,    "pi0py3");
   ntNames.addVar(pi0pz3,    "pi0pz3");

   ntNames.addVar(pi0te4,    "pi0te4");
   ntNames.addVar(pi0px4,    "pi0px4");
   ntNames.addVar(pi0py4,    "pi0py4");
   ntNames.addVar(pi0pz4,    "pi0pz4");

   ntNames.addVar(pi0te5,    "pi0te5");
   ntNames.addVar(pi0px5,    "pi0px5");
   ntNames.addVar(pi0py5,    "pi0py5");
   ntNames.addVar(pi0pz5,    "pi0pz5");

   ntNames.addVar(pi0te6,    "pi0te6");
   ntNames.addVar(pi0px6,    "pi0px6");
   ntNames.addVar(pi0py6,    "pi0py6");
   ntNames.addVar(pi0pz6,    "pi0pz6");

   ntNames.addVar(pi0te7,    "pi0te7");
   ntNames.addVar(pi0px7,    "pi0px7");
   ntNames.addVar(pi0py7,    "pi0py7");
   ntNames.addVar(pi0pz7,    "pi0pz7");

   ntNames.addVar(pi0te8,    "pi0te8");
   ntNames.addVar(pi0px8,    "pi0px8");
   ntNames.addVar(pi0py8,    "pi0py8");
   ntNames.addVar(pi0pz8,    "pi0pz8");

   ntNames.addVar(pi0te9,    "pi0te9");
   ntNames.addVar(pi0px9,    "pi0px9");
   ntNames.addVar(pi0py9,    "pi0py9");
   ntNames.addVar(pi0pz9,    "pi0pz9");

   ntNames.addVar(pi0te10,    "pi0te10");
   ntNames.addVar(pi0px10,    "pi0px10");
   ntNames.addVar(pi0py10,    "pi0py10");
   ntNames.addVar(pi0pz10,    "pi0pz10");
...
TwoTrPi0JpsiProc::event( Frame& iFrame )          // anal3 equiv.
{
...
//   double XP[2] = {-10.,-10.}, XPT[2];
   ...
   double PI0PE[kMaxPi0] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
   double PI0PX[kMaxPi0] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
   double PI0PY[kMaxPi0] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
   double PI0PZ[kMaxPi0] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
   double P0PullM[kMaxPi0] = {-100.,-100.,-100.,-100.,-100.,-100.,-100.,-100.,-100.,-100.};
   double PI0HIE[kMaxPi0] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
   double PI0LOE[kMaxPi0] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
	 ...
	 if((pionFit->pmag() > 0.05) && (pionFit->pmag() < 1.8)) {
	    ...
	    FATable< NavTrack >::const_iterator trackItr2 = trackItr;
		  ...
		  //cerr << "tagged Jpsi: " << mm << endl;
                  ...
                  //if( fabs( mm-3.097 ) < 0.01 ) {
		  if( fabs( mm-3.097 ) < 0.05 ) {
                     good_jpsi = 1;
		     if( fabs( mm-3.097 ) < fabs( best_tag-3.097) ) {
			tagpi1 = pionFit;
			tagpi2 = pionFit2;
			best_tag = mm;
		     }
...
*/
   ...
   // Create a table of pi0s and fill it.
...
//////////////////////////////////////////////////////////////////////////////////
   ...
   double TempChisqF1kk = 1000000.;

//////////////////////////////// do the fit with 4 pions and 1 pi0  ///////////////////
...
//		     HepLorentzVector v5pi (psip.kdFitVec()[5]->lorentzMomentum());
	             HepLorentzVector v6pi0 (psip.kdFitVec()[4]->lorentzMomentum());
	   ...
	   if( (kaon_tracks.size()==2) && (pion_tracks.size()==2) ) {
	     ...
	     for(int i=0; i<2; ++i) 
	       psipkk.newTrack(*pion_tracks[i]);
             psipkk.newPi0(pi0Itr->hiEnShower(),pi0Itr->loEnShower(), FitEvtSettings::instance().beamSpotKD());

	     psipkk.doTheFit();

	     if( (psipkk.chisqVtx()>0) && (psipkk.chisqFit()>0) ) {
               TempChisqF1kk = psipkk.chisqFit();
               if(TempChisqF1kk < psip_kk_fitchisq) {
...
//       KKPi44V[3] = pion_tracks[3]->pz();
   ...
   */
   ...
   ntVal[pi0te1] = PI0PE[0];
   ntVal[pi0px1] = PI0PX[0];
   ntVal[pi0py1] = PI0PY[0];
   ntVal[pi0pz1] = PI0PZ[0];
   ntVal[pi0te2] = PI0PE[1];
   ntVal[pi0px2] = PI0PX[1];
   ntVal[pi0py2] = PI0PY[1];
   ntVal[pi0pz2] = PI0PZ[1];
   ntVal[pi0te3] = PI0PE[2];
   ntVal[pi0px3] = PI0PX[2];
   ntVal[pi0py3] = PI0PY[2];
   ntVal[pi0pz3] = PI0PZ[2];
   ntVal[pi0te4] = PI0PE[3];
   ntVal[pi0px4] = PI0PX[3];
   ntVal[pi0py4] = PI0PY[3];
   ntVal[pi0pz4] = PI0PZ[3];
   ntVal[pi0te5] = PI0PE[4];
   ntVal[pi0px5] = PI0PX[4];
   ntVal[pi0py5] = PI0PY[4];
   ntVal[pi0pz5] = PI0PZ[4];
   ntVal[pi0te6] = PI0PE[5];
   ntVal[pi0px6] = PI0PX[5];
   ntVal[pi0py6] = PI0PY[5];
   ntVal[pi0pz6] = PI0PZ[5];
   ntVal[pi0te7] = PI0PE[6];
   ntVal[pi0px7] = PI0PX[6];
   ntVal[pi0py7] = PI0PY[6];
   ntVal[pi0pz7] = PI0PZ[6];
   ntVal[pi0te8] = PI0PE[7];
   ntVal[pi0px8] = PI0PX[7];
   ntVal[pi0py8] = PI0PY[7];
   ntVal[pi0pz8] = PI0PZ[7];
   ntVal[pi0te9] = PI0PE[8];
   ntVal[pi0px9] = PI0PX[8];
   ntVal[pi0py9] = PI0PY[8];
   ntVal[pi0pz9] = PI0PZ[8];
   ntVal[pi0te10] = PI0PE[9];
   ntVal[pi0px10] = PI0PX[9];
   ntVal[pi0py10] = PI0PY[9];
   ntVal[pi0pz10] = PI0PZ[9];

   ntVal[f1pi0te] = PI0F1PE;
   ntVal[f1pi0px] = PI0F1PX;
   ntVal[f1pi0py] = PI0F1PY;
   ntVal[f1pi0pz] = PI0F1PZ;
   ntVal[f1pi0hie] = PI0F1HIE;
   ntVal[f1pi0loe] = PI0F1LOE;
...
ActionBase::ActionResult
TwoTrPi0JpsiProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
TwoTrPi0JpsiProc::endRun( Frame& iFrame )         // anal4 equiv.
{
...
int TwoTrPi0JpsiProc::CompareKins( FAItem<KTKinematicData>  &k1, 
...
/*
// return 1 if they are they same kinematical object
int TwoTrPi0JpsiProc::CompareKins( FAItem<TDKinematicFit>  &k1, 
...
double TwoTrPi0JpsiProc::calcDOCA( double iD,
		       	     double iPhi )
{
