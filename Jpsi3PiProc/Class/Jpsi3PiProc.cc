...
// user include files
#include "Jpsi3PiProc/Jpsi3PiProc.h"
...
//
static const char* const kFacilityString = "Processor.Jpsi3PiProc" ;
...
//
Jpsi3PiProc::Jpsi3PiProc( void )               // anal1
   : Processor( "Jpsi3PiProc" )
{
   ...
   bind( &Jpsi3PiProc::event,    Stream::kEvent );
   bind( &Jpsi3PiProc::beginRun, Stream::kBeginRun );
   //bind( &Jpsi3PiProc::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
Jpsi3PiProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
Jpsi3PiProc::terminate( void )     // anal5 "Interactive"
{
...
void
Jpsi3PiProc::hist_book( HIHistoManager& iHistoManager )
{
...
Jpsi3PiProc::event( Frame& iFrame )          // anal3 equiv.
{
...
ActionBase::ActionResult
Jpsi3PiProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
Jpsi3PiProc::endRun( Frame& iFrame )         // anal4 equiv.
{
...
double Jpsi3PiProc::calcDOCA( double iD,
		       	     double iPhi )
{
