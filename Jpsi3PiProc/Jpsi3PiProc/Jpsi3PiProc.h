...
// Module:      Jpsi3PiProc
//
/**\class Jpsi3PiProc Jpsi3PiProc.h Jpsi3PiProc/Jpsi3PiProc.h
...
class Jpsi3PiProc : public Processor
{
   ...
   public:
      ...
      Jpsi3PiProc( void );                      // anal1 
      virtual ~Jpsi3PiProc();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor ----------------
      Jpsi3PiProc( const Jpsi3PiProc& );

      // ------------ assignment operator(s) ---------------------
      const Jpsi3PiProc& operator=( const Jpsi3PiProc& );

      // ------------ private member functions -------------------
      void bind( 
         ActionBase::ActionResult (Jpsi3PiProc::*iMethod)( Frame& ),
