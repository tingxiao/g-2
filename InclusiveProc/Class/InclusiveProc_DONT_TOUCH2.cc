...
// Module:      InclusiveProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor InclusiveProc:
//              creates a new InclusiveProc instance each time 
