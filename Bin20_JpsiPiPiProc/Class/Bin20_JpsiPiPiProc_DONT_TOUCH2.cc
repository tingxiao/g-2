...
// Module:      Bin20_JpsiPiPiProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor Bin20_JpsiPiPiProc:
//              creates a new Bin20_JpsiPiPiProc instance each time 
