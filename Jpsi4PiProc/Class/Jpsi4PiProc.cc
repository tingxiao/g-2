...
//
static const char* const kFacilityString = "Processor.Jpsi4PiProc" ;
...
//
Jpsi4PiProc::Jpsi4PiProc( void )               // anal1
   : Processor( "Jpsi4PiProc" )
{
   ...
   bind( &Jpsi4PiProc::event,    Stream::kEvent );
   bind( &Jpsi4PiProc::beginRun, Stream::kBeginRun );
   //bind( &Jpsi4PiProc::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
Jpsi4PiProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
Jpsi4PiProc::terminate( void )     // anal5 "Interactive"
{
...
void
Jpsi4PiProc::hist_book( HIHistoManager& iHistoManager )
{
...
Jpsi4PiProc::event( Frame& iFrame )          // anal3 equiv.
{
...
//////////////////////////////// do the fit with 6 pions  ///////////////////
   ...
   if(psip_pipi_vtxchisq>50 || psip_pipi_fitchisq>50)
           return ActionBase::kFailed;
...
ActionBase::ActionResult
Jpsi4PiProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
Jpsi4PiProc::endRun( Frame& iFrame )         // anal4 equiv.
{
...
double Jpsi4PiProc::calcDOCA( double iD,
		       	     double iPhi )
{
