...
// Module:      Jpsi4PiProc
//
/**\class Jpsi4PiProc Jpsi4PiProc.h Jpsi4PiProc/Jpsi4PiProc.h
...
class Jpsi4PiProc : public Processor
{
   ...
   public:
      ...
      Jpsi4PiProc( void );                      // anal1 
      virtual ~Jpsi4PiProc();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor ----------------
      Jpsi4PiProc( const Jpsi4PiProc& );

      // ------------ assignment operator(s) ---------------------
      const Jpsi4PiProc& operator=( const Jpsi4PiProc& );
