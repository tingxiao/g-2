...
// user include files
#include "FivePiProc/FivePiProc.h"
...
//
static const char* const kFacilityString = "Processor.FivePiProc" ;
...
//
FivePiProc::FivePiProc( void )               // anal1
   : Processor( "FivePiProc" )
{
   ...
   bind( &FivePiProc::event,    Stream::kEvent );
   bind( &FivePiProc::beginRun, Stream::kBeginRun );
   //bind( &FivePiProc::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
FivePiProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
FivePiProc::terminate( void )     // anal5 "Interactive"
{
...
void
FivePiProc::hist_book( HIHistoManager& iHistoManager )
{
...
FivePiProc::event( Frame& iFrame )          // anal3 equiv.
{
...
ActionBase::ActionResult
FivePiProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
FivePiProc::endRun( Frame& iFrame )         // anal4 equiv.
{
...
double FivePiProc::calcDOCA( double iD,
		       	     double iPhi )
{
