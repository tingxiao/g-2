...
// Module:      InclusivePiPiPhiProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor InclusivePiPiPhiProc:
//              creates a new InclusivePiPiPhiProc instance each time 
...
makeProcessor( void )
{
   return new InclusivePiPiPhiProc;
}
