...
//
static const char* const kFacilityString = "Processor.PentaProc" ;
...
//
PentaProc::PentaProc( void )               // anal1
   : Processor( "PentaProc" )
{
   ...
   bind( &PentaProc::event,    Stream::kEvent );
   bind( &PentaProc::beginRun, Stream::kBeginRun );
   //bind( &PentaProc::endRun,   Stream::kEndRun );
...
// --------------------------- init method -------------------------
void
PentaProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
PentaProc::terminate( void )     // anal5 "Interactive"
{
...
enum {
       ...
       k_pp_P1_E, k_pp_P1_Px, k_pp_P1_Py, k_pp_P1_Pz,
       k_pp_P2_E, k_pp_P2_Px, k_pp_P2_Py, k_pp_P2_Pz, 
       k_pp_P3_E, k_pp_P3_Px, k_pp_P3_Py, k_pp_P3_Pz, 
       k_pp_P4_E, k_pp_P4_Px, k_pp_P4_Py, k_pp_P4_Pz, 
       k_pp_P5_E, k_pp_P5_Px, k_pp_P5_Py, k_pp_P5_Pz, 
       k_pp_P6_E, k_pp_P6_Px, k_pp_P6_Py, k_pp_P6_Pz, 
       k_pp_P7_E, k_pp_P7_Px, k_pp_P7_Py, k_pp_P7_Pz, 
       k_pp_P8_E, k_pp_P8_Px, k_pp_P8_Py, k_pp_P8_Pz, 
       ...
       k_pcharge_1, k_pcharge_2, k_pcharge_3, k_pcharge_4, k_pcharge_5, k_pcharge_6, k_pcharge_7, k_pcharge_8,
       k_kcharge_1, k_kcharge_2,
       k_EP_1, k_EP_2, k_EP_3, k_EP_4, k_EP_5, k_EP_6, k_EP_7, k_EP_8,
       k_pEP_1, k_pEP_2, k_pEP_3, k_pEP_4, k_pEP_5, k_pEP_6, k_pEP_7, k_pEP_8,
       k_kEP_1, k_kEP_2,
...
void
PentaProc::hist_book( HIHistoManager& iHistoManager )
{
   ...
   ntNames.addVar(k_pcharge_1, "PCharge1");
   ntNames.addVar(k_pcharge_2, "PCharge2");
   ntNames.addVar(k_pcharge_3, "PCharge3");
   ntNames.addVar(k_pcharge_4, "PCharge4");
   ntNames.addVar(k_pcharge_5, "PCharge5");
   ntNames.addVar(k_pcharge_6, "PCharge6");
   ntNames.addVar(k_pcharge_7, "PCharge7");
   ntNames.addVar(k_pcharge_8, "PCharge8");
   ...
   ntNames.addVar(k_pp_P1_E, "PP1E");
   ntNames.addVar(k_pp_P1_Px, "PP1Px");
   ntNames.addVar(k_pp_P1_Py, "PP1Py");
   ntNames.addVar(k_pp_P1_Pz, "PP1Pz");
   ntNames.addVar(k_pp_P2_E, "PP2E");
   ntNames.addVar(k_pp_P2_Px, "PP2Px");
   ntNames.addVar(k_pp_P2_Py, "PP2Py");
   ntNames.addVar(k_pp_P2_Pz, "PP2Pz");
   ntNames.addVar(k_pp_P3_E, "PP3E");
   ntNames.addVar(k_pp_P3_Px, "PP3Px");
   ntNames.addVar(k_pp_P3_Py, "PP3Py");
   ntNames.addVar(k_pp_P3_Pz, "PP3Pz");
   ntNames.addVar(k_pp_P4_E, "PP4E");
   ntNames.addVar(k_pp_P4_Px, "PP4Px");
   ntNames.addVar(k_pp_P4_Py, "PP4Py");
   ntNames.addVar(k_pp_P4_Pz, "PP4Pz");
   ntNames.addVar(k_pp_P5_E, "PP5E");
   ntNames.addVar(k_pp_P5_Px, "PP5Px");
   ntNames.addVar(k_pp_P5_Py, "PP5Py");
   ntNames.addVar(k_pp_P5_Pz, "PP5Pz");
   ntNames.addVar(k_pp_P6_E, "PP6E");
   ntNames.addVar(k_pp_P6_Px, "PP6Px");
   ntNames.addVar(k_pp_P6_Py, "PP6Py");
   ntNames.addVar(k_pp_P6_Pz, "PP6Pz");
   ntNames.addVar(k_pp_P7_E, "PP7E");
   ntNames.addVar(k_pp_P7_Px, "PP7Px");
   ntNames.addVar(k_pp_P7_Py, "PP7Py");
   ntNames.addVar(k_pp_P7_Pz, "PP7Pz");
   ntNames.addVar(k_pp_P8_E, "PP8E");
   ntNames.addVar(k_pp_P8_Px, "PP8Px");
   ntNames.addVar(k_pp_P8_Py, "PP8Py");
   ntNames.addVar(k_pp_P8_Pz, "PP8Pz");
   ...
   ntNames.addVar(k_pEP_1, "pEoP1");
   ntNames.addVar(k_pEP_2, "pEoP2");
   ntNames.addVar(k_pEP_3, "pEoP3");
   ntNames.addVar(k_pEP_4, "pEoP4");
   ntNames.addVar(k_pEP_5, "pEoP5");
   ntNames.addVar(k_pEP_6, "pEoP6");
   ntNames.addVar(k_pEP_7, "pEoP7");
   ntNames.addVar(k_pEP_8, "pEoP8");
...
PentaProc::event( Frame& iFrame )          // anal3 equiv.
{
   ...
   double pPE[kMaxTrack-2] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};   // protons
   double pPPx[kMaxTrack-2] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
   double pPPy[kMaxTrack-2] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
   double pPPz[kMaxTrack-2] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
   double pCharge[kMaxTrack-2] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
   double pEOP[kMaxTrack-2] = {-10.,-10.,-10.,-10.,-10.,-10.,-10.,-10.};
...
//      return ActionBase::kFailed;
         ...
         ++trackItr )
   {
       ...
       if( isGoodProton( *trackItr ) && numTrack2 < (kMaxTrack-2)) {
          FAItem<TDKinematicFit> protonFit = trackItr->protonFit();
          proton_tracks.push_back(protonFit);
          pPE[numTrack2] = protonFit->energy();
          pPPx[numTrack2] = protonFit->px();
          pPPy[numTrack2] = protonFit->py();
          pPPz[numTrack2] = protonFit->pz();
          pCharge[numTrack2] = protonFit->charge();
          pEOP[numTrack2] = trackItr->elecId().eOverP();

          numTrack2++;  // number of good protons
       }
   }


   if( proton_tracks.size()<1 )
      return ActionBase::kFailed;
   ...
   ntVal[k_pp_P1_E] = pPE[0];
   ntVal[k_pp_P1_Px] = pPPx[0];
   ntVal[k_pp_P1_Py] = pPPy[0];
   ntVal[k_pp_P1_Pz] = pPPz[0];
   ntVal[k_pp_P2_E] = pPE[1];
   ntVal[k_pp_P2_Px] = pPPx[1];
   ntVal[k_pp_P2_Py] = pPPy[1];
   ntVal[k_pp_P2_Pz] = pPPz[1];
   ntVal[k_pp_P3_E] = pPE[2];
   ntVal[k_pp_P3_Px] = pPPx[2];
   ntVal[k_pp_P3_Py] = pPPy[2];
   ntVal[k_pp_P3_Pz] = pPPz[2];
   ntVal[k_pp_P4_E] = pPE[3];
   ntVal[k_pp_P4_Px] = pPPx[3];
   ntVal[k_pp_P4_Py] = pPPy[3];
   ntVal[k_pp_P4_Pz] = pPPz[3];
   ntVal[k_pp_P5_E] = pPE[4];
   ntVal[k_pp_P5_Px] = pPPx[4];
   ntVal[k_pp_P5_Py] = pPPy[4];
   ntVal[k_pp_P5_Pz] = pPPz[4];
   ntVal[k_pp_P6_E] = pPE[5];
   ntVal[k_pp_P6_Px] = pPPx[5];
   ntVal[k_pp_P6_Py] = pPPy[5];
   ntVal[k_pp_P6_Pz] = pPPz[5];
   ntVal[k_pp_P7_E] = pPE[6];
   ntVal[k_pp_P7_Px] = pPPx[6];
   ntVal[k_pp_P7_Py] = pPPy[6];
   ntVal[k_pp_P7_Pz] = pPPz[6];
   ntVal[k_pp_P8_E] = pPE[7];
   ntVal[k_pp_P8_Px] = pPPx[7];
   ntVal[k_pp_P8_Py] = pPPy[7];
   ntVal[k_pp_P8_Pz] = pPPz[7];
   ...
   ntVal[k_pcharge_1] = pCharge[0];
   ntVal[k_pcharge_2] = pCharge[1];
   ntVal[k_pcharge_3] = pCharge[2];
   ntVal[k_pcharge_4] = pCharge[3];
   ntVal[k_pcharge_5] = pCharge[4];
   ntVal[k_pcharge_6] = pCharge[5];
   ntVal[k_pcharge_7] = pCharge[6];
   ntVal[k_pcharge_8] = pCharge[7];
...
ActionBase::ActionResult
PentaProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
PentaProc::endRun( Frame& iFrame )         // anal4 equiv.
{
...
int PentaProc::CompareKins( FAItem<KTKinematicData>  &k1, 
...
/*
// return 1 if they are they same kinematical object
int PentaProc::CompareKins( FAItem<TDKinematicFit>  &k1, 
...
double PentaProc::calcDOCA( double iD,
		       	     double iPhi )
{
