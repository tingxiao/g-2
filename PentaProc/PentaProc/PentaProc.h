...
// Module:      PentaProc
//
/**\class PentaProc PentaProc.h PentaProc/PentaProc.h
...
class PentaProc : public Processor
{
   ...
   public:
      ...
      PentaProc( void );                      // anal1 
      virtual ~PentaProc();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor ----------------
      PentaProc( const PentaProc& );

      // ------------ assignment operator(s) ---------------------
      const PentaProc& operator=( const PentaProc& );

      // ------------ private member functions -------------------
      void bind( 
         ActionBase::ActionResult (PentaProc::*iMethod)( Frame& ),
