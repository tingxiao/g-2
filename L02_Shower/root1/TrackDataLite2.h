...
#ifndef _TRACK_DATA_LITE2_
#define _TRACK_DATA_LITE2_
...
class TrackDataLite2
{
 public:
  TrackDataLite2() {  return; }
  TrackDataLite2( const int new_id,
	     const double new_px, const double new_py, const double new_pz, const double new_e, 
	     const double new_chisq, const double new_pullm, const double new_hi, 
	     const double new_lo, const double new_charge, const double new_doca, 
  ...
  */
  ...
  double const ChiSQ() const { return chisq; }
  double const PullM() const { return pullm; }
  double const Hi() const { return hi; }
  ...
  double const Lo() const { return lo; }
  ...
  void SetChiSQ(const double new_val) { chisq = new_val; }
  void SetPullM(const double new_val) { pullm = new_val; }
  void SetHi(const double new_val) { hi = new_val; }
  ...
  void SetLo(const double new_val) { lo = new_val; } 
