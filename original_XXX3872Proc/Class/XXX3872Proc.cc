...
enum {
chisqv1,chisqf1,         //chisq of 4C fit, add. ISR
chisqv2,chisqf2,         //chisq of 4C fit, add. FSR
...
f1trte3,f1trpx3,f1trpy3,f1trpz3,f1trte4,f1trpx4,f1trpy4,f1trpz4,  // add.FSR
...
///////////////////////////////////// # of showers >= 1 ////////////////////////////////
   ...
   for ( FATable< NavShower >::const_iterator showerItr = showerBegin;
         ...
         ++showerItr )
      {
         ...
         if(j<20){
           EE[j] = showerItr->attributes().energy();
         }
	...
	if(showerTable.size() > 1){
	         ...
	         ++showerItr )
	   {
  	     ...
  	     if(showerItr->attributes().x925() < 1)  continue;
	           ...
	           for ( FATable< NavShower >::const_iterator showerItr2 = showerItr+1;
        	         showerItr2 != showerEnd ;
                	 ++showerItr2 )
          	   {
	              if(showerItr2->attributes().x925() < 1)  continue;
	      ...
	      // do the fit
		      ...
		      FitEvt pipitrtr1( "Pipitrtr1", FitEvt::k_P4VecCM );
        	      pipitrtr1.newPhoton(*showerItr);
		      pipitrtr1.newPhoton(*showerItr2);
		      ...
		      if( (pipitrtr1.chisqVtx()>0) && (pipitrtr1.chisqFit()>0) ) {
        		 ...
        		 HepLorentzVector vg (pipitrtr1.kdFitVec()[1]->lorentzMomentum());
		         HepLorentzVector v1 (pipitrtr1.kdFitVec()[2]->lorentzMomentum());
		         HepLorentzVector v2 (pipitrtr1.kdFitVec()[3]->lorentzMomentum());
	        	 HepLorentzVector v3 (pipitrtr1.kdFitVec()[4]->lorentzMomentum());
	        	 HepLorentzVector v4 (pipitrtr1.kdFitVec()[5]->lorentzMomentum());

		         TempChisqV1 = pipitrtr1.chisqVtx();
		         TempChisqF1 = pipitrtr1.chisqFit();
	        	 ...
	        	 if(TempChisqF1 < ChisqF1){
		            ...
		            E9251 = showerItr->attributes().x925();
                            E2 = showerItr2->attributes().energy();
                            Theta2 = showerItr2->attributes().theta();
                            Phi2 = showerItr2->attributes().phi();
                            E9252 = showerItr2->attributes().x925();
