...
//
static const char* const kFacilityString = "Processor.Bin50_JpsiPiPiProc" ;
...
//
Bin50_JpsiPiPiProc::Bin50_JpsiPiPiProc( void )               // anal1
   : Processor( "Bin50_JpsiPiPiProc" )
{
   ...
   bind( &Bin50_JpsiPiPiProc::event,    Stream::kEvent );
   bind( &Bin50_JpsiPiPiProc::beginRun, Stream::kBeginRun );
   //bind( &Bin50_JpsiPiPiProc::endRun,   Stream::kEndRun );
...
Bin50_JpsiPiPiProc::~Bin50_JpsiPiPiProc()                    // anal5
{
...
// --------------------------- init method -------------------------
void
Bin50_JpsiPiPiProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
Bin50_JpsiPiPiProc::terminate( void )     // anal5 "Interactive"
{
...
void
Bin50_JpsiPiPiProc::hist_book( HIHistoManager& iHistoManager )
{
   ...
   h_pip_eop1 = iHistoManager.histogram(501, "pi+ E/p, p=0-50 MeV", 2000, 0., 2);
   h_pip_eop2 = iHistoManager.histogram(502, "pi+ E/p, p=50-100 MeV", 2000, 0., 2);
   h_pip_eop3 = iHistoManager.histogram(503, "pi+ E/p, p=100-150 MeV", 2000, 0., 2);
   h_pip_eop4 = iHistoManager.histogram(504, "pi+ E/p, p=150-200 MeV", 2000, 0., 2);
   h_pip_eop5 = iHistoManager.histogram(505, "pi+ E/p, p=200-250 MeV", 2000, 0., 2);
   h_pip_eop6 = iHistoManager.histogram(506, "pi+ E/p, p=250-300 MeV", 2000, 0., 2);
   h_pip_eop7 = iHistoManager.histogram(507, "pi+ E/p, p=300-350 MeV", 2000, 0., 2);
   h_pip_eop8 = iHistoManager.histogram(508, "pi+ E/p, p=350-400 MeV", 2000, 0., 2);
   h_pip_eop9 = iHistoManager.histogram(509, "pi+ E/p, p=400-450 MeV", 2000, 0., 2);
   h_pip_eop10 = iHistoManager.histogram(510, "pi+ E/p, p=450-500 MeV", 2000, 0., 2);
   h_pip_eop11 = iHistoManager.histogram(511, "pi+ E/p, p=500-550 MeV", 2000, 0., 2);
   h_pip_eop12 = iHistoManager.histogram(512, "pi+ E/p, p=550-600 MeV", 2000, 0., 2);
   h_pip_eop13 = iHistoManager.histogram(513, "pi+ E/p, p=600-650 MeV", 2000, 0., 2);
   h_pip_eop14 = iHistoManager.histogram(514, "pi+ E/p, p=650-700 MeV", 2000, 0., 2);
   h_pip_eop15 = iHistoManager.histogram(515, "pi+ E/p, p=700-750 MeV", 2000, 0., 2);
   h_pip_eop16 = iHistoManager.histogram(516, "pi+ E/p, p=750-800 MeV", 2000, 0., 2);
   h_pip_eop17 = iHistoManager.histogram(517, "pi+ E/p, p=800-850 MeV", 2000, 0., 2);
   h_pip_eop18 = iHistoManager.histogram(518, "pi+ E/p, p=850-900 MeV", 2000, 0., 2);
   h_pip_eop19 = iHistoManager.histogram(519, "pi+ E/p, p=900-950 MeV", 2000, 0., 2);
   h_pip_eop20 = iHistoManager.histogram(520, "pi+ E/p, p=950-1000 MeV", 2000, 0., 2);
   h_pip_eop21 = iHistoManager.histogram(521, "pi+ E/p, p=1000-1050 MeV", 2000, 0., 2);
   h_pip_eop22 = iHistoManager.histogram(522, "pi+ E/p, p=1050-1100 MeV", 2000, 0., 2);
   h_pip_eop23 = iHistoManager.histogram(523, "pi+ E/p, p=1100-1150 MeV", 2000, 0., 2);
   h_pip_eop24 = iHistoManager.histogram(524, "pi+ E/p, p=1150-1200 MeV", 2000, 0., 2);
   h_pip_eop25 = iHistoManager.histogram(525, "pi+ E/p, p=1200-1250 MeV", 2000, 0., 2);
   h_pip_eop26 = iHistoManager.histogram(526, "pi+ E/p, p=1250-1300 MeV", 2000, 0., 2);
   h_pip_eop27 = iHistoManager.histogram(527, "pi+ E/p, p=1300-1350 MeV", 2000, 0., 2);
   h_pip_eop28 = iHistoManager.histogram(528, "pi+ E/p, p=1350-1400 MeV", 2000, 0., 2);
   h_pip_eop29 = iHistoManager.histogram(529, "pi+ E/p, p=1400-1450 MeV", 2000, 0., 2);
   h_pip_eop30 = iHistoManager.histogram(530, "pi+ E/p, p=1450-1500 MeV", 2000, 0., 2);
   h_pip_eop31 = iHistoManager.histogram(531, "pi+ E/p, p=1500-1550 MeV", 2000, 0., 2);
   h_pip_eop32 = iHistoManager.histogram(532, "pi+ E/p, p=1550-1600 MeV", 2000, 0., 2);
   h_pip_eop33 = iHistoManager.histogram(533, "pi+ E/p, p=1600-1650 MeV", 2000, 0., 2);
   h_pip_eop34 = iHistoManager.histogram(534, "pi+ E/p, p=1650-1700 MeV", 2000, 0., 2);
   h_pip_eop35 = iHistoManager.histogram(535, "pi+ E/p, p=1700-1750 MeV", 2000, 0., 2);
   h_pip_eop36 = iHistoManager.histogram(536, "pi+ E/p, p=1750-1800 MeV", 2000, 0., 2);
   h_pip_eop37 = iHistoManager.histogram(537, "pi+ E/p, p=1800-1850 MeV", 2000, 0., 2);
   h_pip_eop38 = iHistoManager.histogram(538, "pi+ E/p, p=1850-1900 MeV", 2000, 0., 2);
   h_pip_eop39 = iHistoManager.histogram(539, "pi+ E/p, p=1900-1950 MeV", 2000, 0., 2);
   h_pip_eop40 = iHistoManager.histogram(540, "pi+ E/p, p=1950-2000 MeV", 2000, 0., 2);

   h_pim_eop1 = iHistoManager.histogram(541, "pi- E/p, p=0-50 MeV", 2000, 0., 2);
   h_pim_eop2 = iHistoManager.histogram(542, "pi- E/p, p=50-100 MeV", 2000, 0., 2);
   h_pim_eop3 = iHistoManager.histogram(543, "pi- E/p, p=100-150 MeV", 2000, 0., 2);
   h_pim_eop4 = iHistoManager.histogram(544, "pi- E/p, p=150-200 MeV", 2000, 0., 2);
   h_pim_eop5 = iHistoManager.histogram(545, "pi- E/p, p=200-250 MeV", 2000, 0., 2);
   h_pim_eop6 = iHistoManager.histogram(546, "pi- E/p, p=250-300 MeV", 2000, 0., 2);
   h_pim_eop7 = iHistoManager.histogram(547, "pi- E/p, p=300-350 MeV", 2000, 0., 2);
   h_pim_eop8 = iHistoManager.histogram(548, "pi- E/p, p=350-400 MeV", 2000, 0., 2);
   h_pim_eop9 = iHistoManager.histogram(549, "pi- E/p, p=400-450 MeV", 2000, 0., 2);
   h_pim_eop10 = iHistoManager.histogram(550, "pi- E/p, p=450-500 MeV", 2000, 0., 2);
   h_pim_eop11 = iHistoManager.histogram(551, "pi- E/p, p=500-550 MeV", 2000, 0., 2);
   h_pim_eop12 = iHistoManager.histogram(552, "pi- E/p, p=550-600 MeV", 2000, 0., 2);
   h_pim_eop13 = iHistoManager.histogram(553, "pi- E/p, p=600-650 MeV", 2000, 0., 2);
   h_pim_eop14 = iHistoManager.histogram(554, "pi- E/p, p=650-700 MeV", 2000, 0., 2);
   h_pim_eop15 = iHistoManager.histogram(555, "pi- E/p, p=700-750 MeV", 2000, 0., 2);
   h_pim_eop16 = iHistoManager.histogram(556, "pi- E/p, p=750-800 MeV", 2000, 0., 2);
   h_pim_eop17 = iHistoManager.histogram(557, "pi- E/p, p=800-850 MeV", 2000, 0., 2);
   h_pim_eop18 = iHistoManager.histogram(558, "pi- E/p, p=850-900 MeV", 2000, 0., 2);
   h_pim_eop19 = iHistoManager.histogram(559, "pi- E/p, p=900-950 MeV", 2000, 0., 2);
   h_pim_eop20 = iHistoManager.histogram(560, "pi- E/p, p=950-1000 MeV", 2000, 0., 2);
   h_pim_eop21 = iHistoManager.histogram(561, "pi- E/p, p=1000-1050 MeV", 2000, 0., 2);
   h_pim_eop22 = iHistoManager.histogram(562, "pi- E/p, p=1050-1100 MeV", 2000, 0., 2);
   h_pim_eop23 = iHistoManager.histogram(563, "pi- E/p, p=1100-1150 MeV", 2000, 0., 2);
   h_pim_eop24 = iHistoManager.histogram(564, "pi- E/p, p=1150-1200 MeV", 2000, 0., 2);
   h_pim_eop25 = iHistoManager.histogram(565, "pi- E/p, p=1200-1250 MeV", 2000, 0., 2);
   h_pim_eop26 = iHistoManager.histogram(566, "pi- E/p, p=1250-1300 MeV", 2000, 0., 2);
   h_pim_eop27 = iHistoManager.histogram(567, "pi- E/p, p=1300-1350 MeV", 2000, 0., 2);
   h_pim_eop28 = iHistoManager.histogram(568, "pi- E/p, p=1350-1400 MeV", 2000, 0., 2);
   h_pim_eop29 = iHistoManager.histogram(569, "pi- E/p, p=1400-1450 MeV", 2000, 0., 2);
   h_pim_eop30 = iHistoManager.histogram(570, "pi- E/p, p=1450-1500 MeV", 2000, 0., 2);
   h_pim_eop31 = iHistoManager.histogram(571, "pi- E/p, p=1500-1550 MeV", 2000, 0., 2);
   h_pim_eop32 = iHistoManager.histogram(572, "pi- E/p, p=1550-1600 MeV", 2000, 0., 2);
   h_pim_eop33 = iHistoManager.histogram(573, "pi- E/p, p=1600-1650 MeV", 2000, 0., 2);
   h_pim_eop34 = iHistoManager.histogram(574, "pi- E/p, p=1650-1700 MeV", 2000, 0., 2);
   h_pim_eop35 = iHistoManager.histogram(575, "pi- E/p, p=1700-1750 MeV", 2000, 0., 2);
   h_pim_eop36 = iHistoManager.histogram(576, "pi- E/p, p=1750-1800 MeV", 2000, 0., 2);
   h_pim_eop37 = iHistoManager.histogram(577, "pi- E/p, p=1800-1850 MeV", 2000, 0., 2);
   h_pim_eop38 = iHistoManager.histogram(578, "pi- E/p, p=1850-1900 MeV", 2000, 0., 2);
   h_pim_eop39 = iHistoManager.histogram(579, "pi- E/p, p=1900-1950 MeV", 2000, 0., 2);
   h_pim_eop40 = iHistoManager.histogram(580, "pi- E/p, p=1950-2000 MeV", 2000, 0., 2);

   h_pip_matche_p = iHistoManager.histogram(581, "pi+ matched energy vs. p", 200, 0., 2., 200, 0., 2.);
   h_pim_matche_p = iHistoManager.histogram(582, "pi- matched energy vs. p", 200, 0., 2., 200, 0., 2.);

   h_pion_matche = iHistoManager.histogram(100, "pion matched energy", 200, 0., 2.);

   h_pip_matche1 = iHistoManager.histogram(101, "pi+ matched_energy, p=0-50 MeV", 200, 0., 2);
   h_pip_matche2 = iHistoManager.histogram(102, "pi+ matched_energy, p=50-100 MeV", 200, 0., 2);
   h_pip_matche3 = iHistoManager.histogram(103, "pi+ matched_energy, p=100-150 MeV", 200, 0., 2);
   h_pip_matche4 = iHistoManager.histogram(104, "pi+ matched_energy, p=150-200 MeV", 200, 0., 2);
   h_pip_matche5 = iHistoManager.histogram(105, "pi+ matched_energy, p=200-250 MeV", 200, 0., 2);
   h_pip_matche6 = iHistoManager.histogram(106, "pi+ matched_energy, p=250-300 MeV", 200, 0., 2);
   h_pip_matche7 = iHistoManager.histogram(107, "pi+ matched_energy, p=300-350 MeV", 200, 0., 2);
   h_pip_matche8 = iHistoManager.histogram(108, "pi+ matched_energy, p=350-400 MeV", 200, 0., 2);
   h_pip_matche9 = iHistoManager.histogram(109, "pi+ matched_energy, p=400-450 MeV", 200, 0., 2);
   h_pip_matche10 = iHistoManager.histogram(110, "pi+ matched_energy, p=450-500 MeV", 200, 0., 2);
   h_pip_matche11 = iHistoManager.histogram(111, "pi+ matched_energy, p=500-550 MeV", 200, 0., 2);
   h_pip_matche12 = iHistoManager.histogram(112, "pi+ matched_energy, p=550-600 MeV", 200, 0., 2);
   h_pip_matche13 = iHistoManager.histogram(113, "pi+ matched_energy, p=600-650 MeV", 200, 0., 2);
   h_pip_matche14 = iHistoManager.histogram(114, "pi+ matched_energy, p=650-700 MeV", 200, 0., 2);
   h_pip_matche15 = iHistoManager.histogram(115, "pi+ matched_energy, p=700-750 MeV", 200, 0., 2);
   h_pip_matche16 = iHistoManager.histogram(116, "pi+ matched_energy, p=750-800 MeV", 200, 0., 2);
   h_pip_matche17 = iHistoManager.histogram(117, "pi+ matched_energy, p=800-850 MeV", 200, 0., 2);
   h_pip_matche18 = iHistoManager.histogram(118, "pi+ matched_energy, p=850-900 MeV", 200, 0., 2);
   h_pip_matche19 = iHistoManager.histogram(119, "pi+ matched_energy, p=900-950 MeV", 200, 0., 2);
   h_pip_matche20 = iHistoManager.histogram(120, "pi+ matched_energy, p=950-1000 MeV", 200, 0., 2);
   h_pip_matche21 = iHistoManager.histogram(121, "pi+ matched_energy, p=1000-1050 MeV", 200, 0., 2);
   h_pip_matche22 = iHistoManager.histogram(122, "pi+ matched_energy, p=1050-1100 MeV", 200, 0., 2);
   h_pip_matche23 = iHistoManager.histogram(123, "pi+ matched_energy, p=1100-1150 MeV", 200, 0., 2);
   h_pip_matche24 = iHistoManager.histogram(124, "pi+ matched_energy, p=1150-1200 MeV", 200, 0., 2);
   h_pip_matche25 = iHistoManager.histogram(125, "pi+ matched_energy, p=1200-1250 MeV", 200, 0., 2);
   h_pip_matche26 = iHistoManager.histogram(126, "pi+ matched_energy, p=1250-1300 MeV", 200, 0., 2);
   h_pip_matche27 = iHistoManager.histogram(127, "pi+ matched_energy, p=1300-1350 MeV", 200, 0., 2);
   h_pip_matche28 = iHistoManager.histogram(128, "pi+ matched_energy, p=1350-1400 MeV", 200, 0., 2);
   h_pip_matche29 = iHistoManager.histogram(129, "pi+ matched_energy, p=1400-1450 MeV", 200, 0., 2);
   h_pip_matche30 = iHistoManager.histogram(130, "pi+ matched_energy, p=1450-1500 MeV", 200, 0., 2);
   h_pip_matche31 = iHistoManager.histogram(131, "pi+ matched_energy, p=1500-1550 MeV", 200, 0., 2);
   h_pip_matche32 = iHistoManager.histogram(132, "pi+ matched_energy, p=1550-1600 MeV", 200, 0., 2);
   h_pip_matche33 = iHistoManager.histogram(133, "pi+ matched_energy, p=1600-1650 MeV", 200, 0., 2);
   h_pip_matche34 = iHistoManager.histogram(134, "pi+ matched_energy, p=1650-1700 MeV", 200, 0., 2);
   h_pip_matche35 = iHistoManager.histogram(135, "pi+ matched_energy, p=1700-1750 MeV", 200, 0., 2);
   h_pip_matche36 = iHistoManager.histogram(136, "pi+ matched_energy, p=1750-1800 MeV", 200, 0., 2);
   h_pip_matche37 = iHistoManager.histogram(137, "pi+ matched_energy, p=1800-1850 MeV", 200, 0., 2);
   h_pip_matche38 = iHistoManager.histogram(138, "pi+ matched_energy, p=1850-1900 MeV", 200, 0., 2);
   h_pip_matche39 = iHistoManager.histogram(139, "pi+ matched_energy, p=1900-1950 MeV", 200, 0., 2);
   h_pip_matche40 = iHistoManager.histogram(140, "pi+ matched_energy, p=1950-2000 MeV", 200, 0., 2);

   h_pim_matche1 = iHistoManager.histogram(141, "pi- matched_energy, p=0-50 MeV", 200, 0., 2);
   h_pim_matche2 = iHistoManager.histogram(142, "pi- matched_energy, p=50-100 MeV", 200, 0., 2);
   h_pim_matche3 = iHistoManager.histogram(143, "pi- matched_energy, p=100-150 MeV", 200, 0., 2);
   h_pim_matche4 = iHistoManager.histogram(144, "pi- matched_energy, p=150-200 MeV", 200, 0., 2);
   h_pim_matche5 = iHistoManager.histogram(145, "pi- matched_energy, p=200-250 MeV", 200, 0., 2);
   h_pim_matche6 = iHistoManager.histogram(146, "pi- matched_energy, p=250-300 MeV", 200, 0., 2);
   h_pim_matche7 = iHistoManager.histogram(147, "pi- matched_energy, p=300-350 MeV", 200, 0., 2);
   h_pim_matche8 = iHistoManager.histogram(148, "pi- matched_energy, p=350-400 MeV", 200, 0., 2);
   h_pim_matche9 = iHistoManager.histogram(149, "pi- matched_energy, p=400-450 MeV", 200, 0., 2);
   h_pim_matche10 = iHistoManager.histogram(150, "pi- matched_energy, p=450-500 MeV", 200, 0., 2);
   h_pim_matche11 = iHistoManager.histogram(151, "pi- matched_energy, p=500-550 MeV", 200, 0., 2);
   h_pim_matche12 = iHistoManager.histogram(152, "pi- matched_energy, p=550-600 MeV", 200, 0., 2);
   h_pim_matche13 = iHistoManager.histogram(153, "pi- matched_energy, p=600-650 MeV", 200, 0., 2);
   h_pim_matche14 = iHistoManager.histogram(154, "pi- matched_energy, p=650-700 MeV", 200, 0., 2);
   h_pim_matche15 = iHistoManager.histogram(155, "pi- matched_energy, p=700-750 MeV", 200, 0., 2);
   h_pim_matche16 = iHistoManager.histogram(156, "pi- matched_energy, p=750-800 MeV", 200, 0., 2);
   h_pim_matche17 = iHistoManager.histogram(157, "pi- matched_energy, p=800-850 MeV", 200, 0., 2);
   h_pim_matche18 = iHistoManager.histogram(158, "pi- matched_energy, p=850-900 MeV", 200, 0., 2);
   h_pim_matche19 = iHistoManager.histogram(159, "pi- matched_energy, p=900-950 MeV", 200, 0., 2);
   h_pim_matche20 = iHistoManager.histogram(160, "pi- matched_energy, p=950-1000 MeV", 200, 0., 2);
   h_pim_matche21 = iHistoManager.histogram(161, "pi- matched_energy, p=1000-1050 MeV", 200, 0., 2);
   h_pim_matche22 = iHistoManager.histogram(162, "pi- matched_energy, p=1050-1100 MeV", 200, 0., 2);
   h_pim_matche23 = iHistoManager.histogram(163, "pi- matched_energy, p=1100-1150 MeV", 200, 0., 2);
   h_pim_matche24 = iHistoManager.histogram(164, "pi- matched_energy, p=1150-1200 MeV", 200, 0., 2);
   h_pim_matche25 = iHistoManager.histogram(165, "pi- matched_energy, p=1200-1250 MeV", 200, 0., 2);
   h_pim_matche26 = iHistoManager.histogram(166, "pi- matched_energy, p=1250-1300 MeV", 200, 0., 2);
   h_pim_matche27 = iHistoManager.histogram(167, "pi- matched_energy, p=1300-1350 MeV", 200, 0., 2);
   h_pim_matche28 = iHistoManager.histogram(168, "pi- matched_energy, p=1350-1400 MeV", 200, 0., 2);
   h_pim_matche29 = iHistoManager.histogram(169, "pi- matched_energy, p=1400-1450 MeV", 200, 0., 2);
   h_pim_matche30 = iHistoManager.histogram(170, "pi- matched_energy, p=1450-1500 MeV", 200, 0., 2);
   h_pim_matche31 = iHistoManager.histogram(171, "pi- matched_energy, p=1500-1550 MeV", 200, 0., 2);
   h_pim_matche32 = iHistoManager.histogram(172, "pi- matched_energy, p=1550-1600 MeV", 200, 0., 2);
   h_pim_matche33 = iHistoManager.histogram(173, "pi- matched_energy, p=1600-1650 MeV", 200, 0., 2);
   h_pim_matche34 = iHistoManager.histogram(174, "pi- matched_energy, p=1650-1700 MeV", 200, 0., 2);
   h_pim_matche35 = iHistoManager.histogram(175, "pi- matched_energy, p=1700-1750 MeV", 200, 0., 2);
   h_pim_matche36 = iHistoManager.histogram(176, "pi- matched_energy, p=1750-1800 MeV", 200, 0., 2);
   h_pim_matche37 = iHistoManager.histogram(177, "pi- matched_energy, p=1800-1850 MeV", 200, 0., 2);
   h_pim_matche38 = iHistoManager.histogram(178, "pi- matched_energy, p=1850-1900 MeV", 200, 0., 2);
   h_pim_matche39 = iHistoManager.histogram(179, "pi- matched_energy, p=1900-1950 MeV", 200, 0., 2);
   h_pim_matche40 = iHistoManager.histogram(180, "pi- matched_energy, p=1950-2000 MeV", 200, 0., 2);

   h_pion_matche_eop = iHistoManager.histogram(600, "pion matched energy after E/p cut", 200, 0., 2.);

   h_pip_matche1_eop = iHistoManager.histogram(601, "pi+ matched_energy_after_eop_cut, p=0-50 MeV", 200, 0., 2);
   h_pip_matche2_eop = iHistoManager.histogram(602, "pi+ matched_energy_after_eop_cut, p=50-100 MeV", 200, 0., 2);
   h_pip_matche3_eop = iHistoManager.histogram(603, "pi+ matched_energy_after_eop_cut, p=100-150 MeV", 200, 0., 2);
   h_pip_matche4_eop = iHistoManager.histogram(604, "pi+ matched_energy_after_eop_cut, p=150-200 MeV", 200, 0., 2);
   h_pip_matche5_eop = iHistoManager.histogram(605, "pi+ matched_energy_after_eop_cut, p=200-250 MeV", 200, 0., 2);
   h_pip_matche6_eop = iHistoManager.histogram(606, "pi+ matched_energy_after_eop_cut, p=250-300 MeV", 200, 0., 2);
   h_pip_matche7_eop = iHistoManager.histogram(607, "pi+ matched_energy_after_eop_cut, p=300-350 MeV", 200, 0., 2);
   h_pip_matche8_eop = iHistoManager.histogram(608, "pi+ matched_energy_after_eop_cut, p=350-400 MeV", 200, 0., 2);
   h_pip_matche9_eop = iHistoManager.histogram(609, "pi+ matched_energy_after_eop_cut, p=400-450 MeV", 200, 0., 2);
   h_pip_matche10_eop = iHistoManager.histogram(610, "pi+ matched_energy_after_eop_cut, p=450-500 MeV", 200, 0., 2);
   h_pip_matche11_eop = iHistoManager.histogram(611, "pi+ matched_energy_after_eop_cut, p=500-550 MeV", 200, 0., 2);
   h_pip_matche12_eop = iHistoManager.histogram(612, "pi+ matched_energy_after_eop_cut, p=550-600 MeV", 200, 0., 2);
   h_pip_matche13_eop = iHistoManager.histogram(613, "pi+ matched_energy_after_eop_cut, p=600-650 MeV", 200, 0., 2);
   h_pip_matche14_eop = iHistoManager.histogram(614, "pi+ matched_energy_after_eop_cut, p=650-700 MeV", 200, 0., 2);
   h_pip_matche15_eop = iHistoManager.histogram(615, "pi+ matched_energy_after_eop_cut, p=700-750 MeV", 200, 0., 2);
   h_pip_matche16_eop = iHistoManager.histogram(616, "pi+ matched_energy_after_eop_cut, p=750-800 MeV", 200, 0., 2);
   h_pip_matche17_eop = iHistoManager.histogram(617, "pi+ matched_energy_after_eop_cut, p=800-850 MeV", 200, 0., 2);
   h_pip_matche18_eop = iHistoManager.histogram(618, "pi+ matched_energy_after_eop_cut, p=850-900 MeV", 200, 0., 2);
   h_pip_matche19_eop = iHistoManager.histogram(619, "pi+ matched_energy_after_eop_cut, p=900-950 MeV", 200, 0., 2);
   h_pip_matche20_eop = iHistoManager.histogram(620, "pi+ matched_energy_after_eop_cut, p=950-1000 MeV", 200, 0., 2);
   h_pip_matche21_eop = iHistoManager.histogram(621, "pi+ matched_energy_after_eop_cut, p=1000-1050 MeV", 200, 0., 2);
   h_pip_matche22_eop = iHistoManager.histogram(622, "pi+ matched_energy_after_eop_cut, p=1050-1100 MeV", 200, 0., 2);
   h_pip_matche23_eop = iHistoManager.histogram(623, "pi+ matched_energy_after_eop_cut, p=1100-1150 MeV", 200, 0., 2);
   h_pip_matche24_eop = iHistoManager.histogram(624, "pi+ matched_energy_after_eop_cut, p=1150-1200 MeV", 200, 0., 2);
   h_pip_matche25_eop = iHistoManager.histogram(625, "pi+ matched_energy_after_eop_cut, p=1200-1250 MeV", 200, 0., 2);
   h_pip_matche26_eop = iHistoManager.histogram(626, "pi+ matched_energy_after_eop_cut, p=1250-1300 MeV", 200, 0., 2);
   h_pip_matche27_eop = iHistoManager.histogram(627, "pi+ matched_energy_after_eop_cut, p=1300-1350 MeV", 200, 0., 2);
   h_pip_matche28_eop = iHistoManager.histogram(628, "pi+ matched_energy_after_eop_cut, p=1350-1400 MeV", 200, 0., 2);
   h_pip_matche29_eop = iHistoManager.histogram(629, "pi+ matched_energy_after_eop_cut, p=1400-1450 MeV", 200, 0., 2);
   h_pip_matche30_eop = iHistoManager.histogram(630, "pi+ matched_energy_after_eop_cut, p=1450-1500 MeV", 200, 0., 2);
   h_pip_matche31_eop = iHistoManager.histogram(631, "pi+ matched_energy_after_eop_cut, p=1500-1550 MeV", 200, 0., 2);
   h_pip_matche32_eop = iHistoManager.histogram(632, "pi+ matched_energy_after_eop_cut, p=1550-1600 MeV", 200, 0., 2);
   h_pip_matche33_eop = iHistoManager.histogram(633, "pi+ matched_energy_after_eop_cut, p=1600-1650 MeV", 200, 0., 2);
   h_pip_matche34_eop = iHistoManager.histogram(634, "pi+ matched_energy_after_eop_cut, p=1650-1700 MeV", 200, 0., 2);
   h_pip_matche35_eop = iHistoManager.histogram(635, "pi+ matched_energy_after_eop_cut, p=1700-1750 MeV", 200, 0., 2);
   h_pip_matche36_eop = iHistoManager.histogram(636, "pi+ matched_energy_after_eop_cut, p=1750-1800 MeV", 200, 0., 2);
   h_pip_matche37_eop = iHistoManager.histogram(637, "pi+ matched_energy_after_eop_cut, p=1800-1850 MeV", 200, 0., 2);
   h_pip_matche38_eop = iHistoManager.histogram(638, "pi+ matched_energy_after_eop_cut, p=1850-1900 MeV", 200, 0., 2);
   h_pip_matche39_eop = iHistoManager.histogram(639, "pi+ matched_energy_after_eop_cut, p=1900-1950 MeV", 200, 0., 2);
   h_pip_matche40_eop = iHistoManager.histogram(640, "pi+ matched_energy_after_eop_cut, p=1950-200 MeV", 200, 0., 2);

   h_pim_matche1_eop = iHistoManager.histogram(641, "pi- matched_energy_after_eop_cut, p=0-50 MeV", 200, 0., 2);
   h_pim_matche2_eop = iHistoManager.histogram(642, "pi- matched_energy_after_eop_cut, p=50-100 MeV", 200, 0., 2);
   h_pim_matche3_eop = iHistoManager.histogram(643, "pi- matched_energy_after_eop_cut, p=100-150 MeV", 200, 0., 2);
   h_pim_matche4_eop = iHistoManager.histogram(644, "pi- matched_energy_after_eop_cut, p=150-200 MeV", 200, 0., 2);
   h_pim_matche5_eop = iHistoManager.histogram(645, "pi- matched_energy_after_eop_cut, p=200-250 MeV", 200, 0., 2);
   h_pim_matche6_eop = iHistoManager.histogram(646, "pi- matched_energy_after_eop_cut, p=250-300 MeV", 200, 0., 2);
   h_pim_matche7_eop = iHistoManager.histogram(647, "pi- matched_energy_after_eop_cut, p=300-350 MeV", 200, 0., 2);
   h_pim_matche8_eop = iHistoManager.histogram(648, "pi- matched_energy_after_eop_cut, p=350-400 MeV", 200, 0., 2);
   h_pim_matche9_eop = iHistoManager.histogram(649, "pi- matched_energy_after_eop_cut, p=400-450 MeV", 200, 0., 2);
   h_pim_matche10_eop = iHistoManager.histogram(650, "pi- matched_energy_after_eop_cut, p=450-500 MeV", 200, 0., 2);
   h_pim_matche11_eop = iHistoManager.histogram(651, "pi- matched_energy_after_eop_cut, p=500-550 MeV", 200, 0., 2);
   h_pim_matche12_eop = iHistoManager.histogram(652, "pi- matched_energy_after_eop_cut, p=550-600 MeV", 200, 0., 2);
   h_pim_matche13_eop = iHistoManager.histogram(653, "pi- matched_energy_after_eop_cut, p=600-650 MeV", 200, 0., 2);
   h_pim_matche14_eop = iHistoManager.histogram(654, "pi- matched_energy_after_eop_cut, p=650-700 MeV", 200, 0., 2);
   h_pim_matche15_eop = iHistoManager.histogram(655, "pi- matched_energy_after_eop_cut, p=700-750 MeV", 200, 0., 2);
   h_pim_matche16_eop = iHistoManager.histogram(656, "pi- matched_energy_after_eop_cut, p=750-800 MeV", 200, 0., 2);
   h_pim_matche17_eop = iHistoManager.histogram(657, "pi- matched_energy_after_eop_cut, p=800-850 MeV", 200, 0., 2);
   h_pim_matche18_eop = iHistoManager.histogram(658, "pi- matched_energy_after_eop_cut, p=850-900 MeV", 200, 0., 2);
   h_pim_matche19_eop = iHistoManager.histogram(659, "pi- matched_energy_after_eop_cut, p=900-950 MeV", 200, 0., 2);
   h_pim_matche20_eop = iHistoManager.histogram(660, "pi- matched_energy_after_eop_cut, p=950-1000 MeV", 200, 0., 2);
   h_pim_matche21_eop = iHistoManager.histogram(661, "pi- matched_energy_after_eop_cut, p=1000-1050 MeV", 200, 0., 2);
   h_pim_matche22_eop = iHistoManager.histogram(662, "pi- matched_energy_after_eop_cut, p=1050-1100 MeV", 200, 0., 2);
   h_pim_matche23_eop = iHistoManager.histogram(663, "pi- matched_energy_after_eop_cut, p=1100-1150 MeV", 200, 0., 2);
   h_pim_matche24_eop = iHistoManager.histogram(664, "pi- matched_energy_after_eop_cut, p=1150-1200 MeV", 200, 0., 2);
   h_pim_matche25_eop = iHistoManager.histogram(665, "pi- matched_energy_after_eop_cut, p=1200-1250 MeV", 200, 0., 2);
   h_pim_matche26_eop = iHistoManager.histogram(666, "pi- matched_energy_after_eop_cut, p=1250-1300 MeV", 200, 0., 2);
   h_pim_matche27_eop = iHistoManager.histogram(667, "pi- matched_energy_after_eop_cut, p=1300-1350 MeV", 200, 0., 2);
   h_pim_matche28_eop = iHistoManager.histogram(668, "pi- matched_energy_after_eop_cut, p=1350-1400 MeV", 200, 0., 2);
   h_pim_matche29_eop = iHistoManager.histogram(669, "pi- matched_energy_after_eop_cut, p=1400-1450 MeV", 200, 0., 2);
   h_pim_matche30_eop = iHistoManager.histogram(670, "pi- matched_energy_after_eop_cut, p=1450-1500 MeV", 200, 0., 2);
   h_pim_matche31_eop = iHistoManager.histogram(671, "pi- matched_energy_after_eop_cut, p=1500-1550 MeV", 200, 0., 2);
   h_pim_matche32_eop = iHistoManager.histogram(672, "pi- matched_energy_after_eop_cut, p=1550-1600 MeV", 200, 0., 2);
   h_pim_matche33_eop = iHistoManager.histogram(673, "pi- matched_energy_after_eop_cut, p=1600-1650 MeV", 200, 0., 2);
   h_pim_matche34_eop = iHistoManager.histogram(674, "pi- matched_energy_after_eop_cut, p=1650-1700 MeV", 200, 0., 2);
   h_pim_matche35_eop = iHistoManager.histogram(675, "pi- matched_energy_after_eop_cut, p=1700-1750 MeV", 200, 0., 2);
   h_pim_matche36_eop = iHistoManager.histogram(676, "pi- matched_energy_after_eop_cut, p=1750-1800 MeV", 200, 0., 2);
   h_pim_matche37_eop = iHistoManager.histogram(677, "pi- matched_energy_after_eop_cut, p=1800-1850 MeV", 200, 0., 2);
   h_pim_matche38_eop = iHistoManager.histogram(678, "pi- matched_energy_after_eop_cut, p=1850-1900 MeV", 200, 0., 2);
   h_pim_matche39_eop = iHistoManager.histogram(679, "pi- matched_energy_after_eop_cut, p=1900-1950 MeV", 200, 0., 2);
   h_pim_matche40_eop = iHistoManager.histogram(680, "pi- matched_energy_after_eop_cut, p=1950-200 MeV", 200, 0., 2);
...
Bin50_JpsiPiPiProc::event( Frame& iFrame )          // anal3 equiv.
{
...
ActionBase::ActionResult
Bin50_JpsiPiPiProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
Bin50_JpsiPiPiProc::endRun( Frame& iFrame )         // anal4 equiv.
{
...
double Bin50_JpsiPiPiProc::calcDOCA( double iD,
		       	     double iPhi )
{
