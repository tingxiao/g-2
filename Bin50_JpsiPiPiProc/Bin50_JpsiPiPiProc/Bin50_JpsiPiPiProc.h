...
//
/**\class Bin50_JpsiPiPiProc Bin50_JpsiPiPiProc.h Bin50_JpsiPiPiProc/Bin50_JpsiPiPiProc.h
...
class Bin50_JpsiPiPiProc : public Processor
{
   ...
   public:
      ...
      Bin50_JpsiPiPiProc( void );                      // anal1 
      virtual ~Bin50_JpsiPiPiProc();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor ----------------
      Bin50_JpsiPiPiProc( const Bin50_JpsiPiPiProc& );

      // ------------ assignment operator(s) ---------------------
      const Bin50_JpsiPiPiProc& operator=( const Bin50_JpsiPiPiProc& );
