...
// Module:      TriggerEffProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor TriggerEffProc:
//              creates a new TriggerEffProc instance each time 
