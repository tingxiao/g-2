...
//
static const char* const kFacilityString = "Processor.TriggerEffProc" ;
...
//
TriggerEffProc::TriggerEffProc( void )               // anal1
   : Processor( "TriggerEffProc" )
{
   ...
   bind( &TriggerEffProc::event,    Stream::kEvent );
   bind( &TriggerEffProc::beginRun, Stream::kBeginRun );
   //bind( &TriggerEffProc::endRun,   Stream::kEndRun );
...
TriggerEffProc::~TriggerEffProc()                    // anal5
{
...
// --------------------------- init method -------------------------
void
TriggerEffProc::init( void )          // anal1 "Interactive"
{
...
// -------------------- terminate method ----------------------------
void
TriggerEffProc::terminate( void )     // anal5 "Interactive"
{
...
void
TriggerEffProc::hist_book( HIHistoManager& iHistoManager )
{
...
TriggerEffProc::event( Frame& iFrame )          // anal3 equiv.
{
...
ActionBase::ActionResult
TriggerEffProc::beginRun( Frame& iFrame )       // anal2 equiv.
{
...
/*
ActionBase::ActionResult
TriggerEffProc::endRun( Frame& iFrame )         // anal4 equiv.
{
