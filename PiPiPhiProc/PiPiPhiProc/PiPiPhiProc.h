...
// Module:      PiPiPhiProc
//
/**\class PiPiPhiProc PiPiPhiProc.h PiPiPhiProc/PiPiPhiProc.h
...
class PiPiPhiProc : public Processor
{
   ...
   public:
      ...
      PiPiPhiProc( void );                      // anal1 
      virtual ~PiPiPhiProc();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor ----------------
      PiPiPhiProc( const PiPiPhiProc& );

      // ------------ assignment operator(s) ---------------------
      const PiPiPhiProc& operator=( const PiPiPhiProc& );

      // ------------ private member functions -------------------
      void bind( 
         ActionBase::ActionResult (PiPiPhiProc::*iMethod)( Frame& ),
