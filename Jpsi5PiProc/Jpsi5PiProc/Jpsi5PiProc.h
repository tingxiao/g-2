...
// Module:      Jpsi5PiProc
//
/**\class Jpsi5PiProc Jpsi5PiProc.h Jpsi5PiProc/Jpsi5PiProc.h
...
class Jpsi5PiProc : public Processor
{
   ...
   public:
      ...
      Jpsi5PiProc( void );                      // anal1 
      virtual ~Jpsi5PiProc();                   // anal5 
   ...
   private:
      // ------------ Constructors and destructor ----------------
      Jpsi5PiProc( const Jpsi5PiProc& );

      // ------------ assignment operator(s) ---------------------
      const Jpsi5PiProc& operator=( const Jpsi5PiProc& );
