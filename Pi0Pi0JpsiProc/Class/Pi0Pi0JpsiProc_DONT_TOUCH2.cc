...
// Module:      Pi0Pi0JpsiProc_DONT_TOUCH2
// 
// Description: DONT TOUCH THIS FILE!
//
//              Factory method to create processor Pi0Pi0JpsiProc:
//              creates a new Pi0Pi0JpsiProc instance each time 
